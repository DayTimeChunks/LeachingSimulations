...
def pest_linear_x(
    ...
    for k in range(len(Kd)):
        ...
        if SS_fresh < error_fresh:
            ...
            try:
                ...
                med30_fresh_error_prc = "No obs | < LD "
        ...
        if SS_aged < error_aged:
            ...
            try:
                ...
                med12_aged_error_prc = "No obs | < LD "
            ...
            try:
                ...
                med30_aged_error_prc = "No obs | < LD "
    ...
    koc_fresh_chosen = (kd_chosen_fresh/10**3/foc)/x
    ...
    return {'Data_stack': stack,
            ...
            'logKd_fresh': log10(kd_chosen_fresh/10**3),
            'Koc_aged': koc_aged_chosen,
            'logKd_aged': log10(kd_chosen_fresh/10**3)}
...
def extract_goodness_pest(
    ...
    if isLiving and isFirstCycle:
        ...
        output_pesti_params[soil_short]['logKd1']['LF'] = pest_data['logKd_fresh']

        output_pesti_params[soil_short]['Koc1']['LA'] = pest_data['Koc_aged']
        output_pesti_params[soil_short]['logKd1']['LA'] = pest_data['logKd_aged']
        ...
        output_pesti_params[soil_short]['logKd1']['SF'] = pest_data['logKd_fresh']

        output_pesti_params[soil_short]['Koc1']['SA'] = pest_data['Koc_aged']
        output_pesti_params[soil_short]['logKd1']['SA'] = pest_data['logKd_aged']
        ...
        output_pesti_params[soil_short]['logKd2']['LF'] = pest_data['logKd_fresh']

        output_pesti_params[soil_short]['Koc2']['LA'] = pest_data['Koc_aged']
        output_pesti_params[soil_short]['logKd2']['LA'] = pest_data['logKd_aged']
        ...
        output_pesti_params[soil_short]['logKd2']['SF'] = pest_data['logKd_fresh']

        output_pesti_params[soil_short]['Koc2']['SA'] = pest_data['Koc_aged']
        output_pesti_params[soil_short]['logKd2']['SA'] = pest_data['logKd_aged']
...
# Currently only uses FOC from Alteck!
def pest_langmuir(
        Kd,  # Kd list range to test
